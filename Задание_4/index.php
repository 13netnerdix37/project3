<?php
    $discography = [['1', 'Atom Heart Mother', '10 октября 1970', 'EMI, Harvest, Capitol', 'LP, CD', 'Золотой (USA)'],
    ['2', 'Meddle', '30 октября 1971', 'EMI, Harvest, Capitol', 'Vinyl, Кассета, CD', 'Платиновый (USA)'],
    ['3', 'Obscured by Clouds', '3 июня 1972', 'EMI, Harvest, Capitol', 'LP, Кассета, CD', 'Золотой (USA)', 'Серебрянный (GBR)'],
    ['4', 'The Dark Side of the Moon', '17 марта 1973', 'Harvest, Capitol, EMI', 'LP, Кассета, CD, SACD', 'Платиновый (USA), Платиновый'],
